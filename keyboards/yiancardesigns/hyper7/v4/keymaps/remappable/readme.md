...
Although Dvorak is mentioned as an example of a non-default layout, it is just one example and this is intended to work with whatever key mapping you prefer.
