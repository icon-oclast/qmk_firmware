...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_combined(
        ...
        KC_F3,   KC_F4,    KC_FIND,  H_WRITE,   QK_LEAD,  H_DOUBLE_QUOTE__PLUS_MINUS, H_COLON__TILDE,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,    KC_6,     KC_7,    KC_8,     KC_9,    KC_0,     KC_LBRC,  KC_RBRC,  KC_NUBS, H_L_BRACE__L_CHEVRON,  H_R_BRACE__R_CHEVRON,  KC_UNDO,      KC_TILD,   KC_BSLS,  KC_PAST,  KC_PMNS,  //27
        ...
        KC_F9,   KC_F10,   H_TTY,    QK_LOCK,   KC_HOME,  KC_END ,  MO(_GREEK), KC_LSFT,  KC_SCLN,     KC_Q,     KC_J,     KC_K,    KC_X,     KC_B,    KC_M,     KC_W, KC_V,   KC_Z,  KC_RSFT, MO(_GREEK),KC_UP,    KC_END,                                                                      KC_P1,     KC_P2,    KC_P3,    KC_EQL,   //26
    ...
    [_APL] = LAYOUT_combined(
        ...
        FT,      FT,      FT,       FT,       FT,       FT,       FT,  FT,  FT,  FT,  UM(PARTIAL_DIFFERENTIAL), UM(SUPERSET_OF), UM(RIGHT_TACK), UM(UPWARDS_ARROW), UM(NOT_EQUAL_TO), UM(INTERSECT), UM(LEFTRIGHT_ARROW),      FT,       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       FT,       FT,  UM(UP_TACK),  UM(THERE_EXISTS), UM(UNION), UM(FORALL), UM(LEMNISCATE),  UM(RIGHT_TACK), UM(DOWNARDS_ARROW),  UM(SUBSET_OF), UM(LESS_THAN_OR_EQUAL), UM(DOWN_TACK),       FT,       FT,      FT,      FT,                                      FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       FT,       FT,       FT,  FT,  UM(LOGICAL_AND),  UM(LEFTWARDS_ARROW), UM(RIGHTWARDS_ARROW), UM(LEFT_CEILING), UM(NOT_ASYMPTOTICALLY_EQUAL_TO), UM(GREATER_THAN_OR_EQUAL), UM(LOGICAL_OR), UM(ASYMPTOTICALLY_EQUAL_TO), UM(LEFT_FLOOR),       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
    ...
    [_GREEK] = LAYOUT_combined(
        ...
        FT,               FT,                 FT,                 FT,                 FT,                 FT,                FT,                FT,                 FT,                FT,               FT,                 FT,                  FT,                FT,
        FT,      FT,      FT,       FT,       FT,                 FT,       FT,       FT,       FT,       FT,       FT,      FT,       FT,      FT,       FT,       FT,       FT,      FT,      FT,      FT,       FT,       FT,                  FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT, UM(CONTOUR_INTEGRAL),  FT,  UM(COPTIC_LC_DEI), UM(DOUBLE_DAGGER), UM(NABLA), UM(CENT), UM(DEGREE), UM(APL_QUAD), UM(DIVISION), UM(MULTIPLICATION), UM(PILCROW), UM(LARGE_CIRCLE), UM(MATHEMATICAL_LEFT_WHITE_SQUARE_BRACKET), UM(MATHEMATICAL_RIGHT_WHITE_SQUARE_BRACKET), UM(DOUBLE_VERTICAL_LINE), UM(SQUARE_IMAGE_OF), UM(SQUARE_ORIGINAL_OF),       FT,       FT,                 FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       FT,       FT,  UM(TWO_DOT_LEADER), UM(MUCH_LESS_THAN),UM(MUCH_GREATER_THAN), UP(GREEK_LC_PI, GREEK_UC_PI), UP(GREEK_LC_PSI, GREEK_UC_PSI), UP(GREEK_LC_PHI, GREEK_UC_PHI),  UP(GREEK_LC_GAMMA, GREEK_UC_GAMMA),  UP(GREEK_LC_CHI, GREEK_UC_CHI), UP(GREEK_LC_RHO, GREEK_UC_RHO), UP(GREEK_LC_LAMDA, GREEK_UC_LAMDA), UM(INTEGRAL), UM(APPROXIMATELY_EQUAL_TO),     FT,      FT,      FT,                            FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       FT,       FT,  UP(GREEK_LC_ALPHA, GREEK_UC_ALPHA), UP(GREEK_LC_OMICRON, GREEK_UC_OMICRON),  UP(GREEK_LC_EPSILON, GREEK_UC_EPSILON), UP(GREEK_LC_UPSILON, GREEK_UC_UPSILON), UP(GREEK_LC_IOTA, GREEK_UC_IOTA), UP(GREEK_LC_DELTA, GREEK_UC_DELTA),UP(GREEK_LC_ETA, GREEK_UC_ETA), UP(GREEK_LC_TAU, GREEK_UC_TAU), UP(GREEK_LC_NU, GREEK_UC_NU), UP(GREEK_LC_SIGMA, GREEK_UC_SIGMA),  UM(HORIZONTAL_BAR),      FT,      FT,      FT,                                     FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       FT,       FT,  FT,  UM(BULLET), UP(GREEK_LC_THETA, GREEK_UC_THETA), UP(GREEK_LC_YOT, GREEK_UC_YOT), UP(GREEK_LC_KAPPA, GREEK_UC_KAPPA), UP(GREEK_LC_XI, GREEK_UC_XI), UP(GREEK_LC_BETA, GREEK_UC_BETA), UP(GREEK_LC_MU, GREEK_UC_MU), UP(GREEK_LC_OMEGA, GREEK_UC_OMEGA), UP(GREEK_LC_FINAL_SIGMA, GREEK_UC_SIGMA),  UP(GREEK_LC_ZETA, GREEK_UC_ZETA),      FT,      FT,      FT,      FT,                            FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,      FT,       FT,      FT,       FT,      FT,       FT,       FT,      FT,      FT,                                     FT,      FT,       FT,      FT,
                                                                                                          FT
    ),
    ...
    [_FN] = LAYOUT_combined(
        ...
        FT,      FT,      FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,      FT,      FT,       FT,       FT,                  FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,     UC_WINC,    FT,    UC_LINX,     FT,       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       UC_NEXT,  FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,      FT,      FT,                                      FT,      FT,       FT,      FT,
        FT,      FT,      FT,       H_LOCK,   FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,     UC_MAC,    UC_WIN,    FT,       FT,       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
        FT,      FT,      FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,      FT,      FT,                                      FT,      FT,       FT,      FT,
                                                                                                          FT
    )
};
